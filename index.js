...
export default class ModalDropdown extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    const { defaultIndex, defaultValue, options } = state;
  ...
  _renderButton() {
    const {
      disabled, accessible, children, textStyle,
    } = this.props;
  ...
  _renderDropdown() {
    const {
      scrollEnabled, showsVerticalScrollIndicator, keyboardShouldPersistTaps, options,
    } = this.props;
    return (
      <FlatList
  ...
  _renderRow = ({ item: rowData, index: rowID }) => {
    const {
      renderRow, dropdownTextStyle, dropdownTextHighlightStyle, accessible,
    } = this.props;
...
exports.printMsg = function() {
  console.log("react-native-modal-dropdown-flatlist");
}
